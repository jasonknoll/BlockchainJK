# Jason Knoll coin (I guess lol)
# This is technically the first node
...
# Connect a new node (this would be automated in a real product)
...
def replaceChain():
    ...
    if (isChainReplaced):
        ...
        response = {'message': "This chain is the largest one",
                    'actualChain': blockchain.chain} # Obviously would need to be more specific
    return jsonify(response), 200
